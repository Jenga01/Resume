                    ...
                    <div class="container">
                        ...
                        <div class="col-sm-3">
                            ...
                            <p>
                                ...
                                <a href="{{$jb->linkedin}}">linkedin</a>
                            </p>
                            @endforeach

                            <p>
                                <a href="{{action('pdfController@saveToPDF', $jb->id)}}">Save as PDF</a>
                            </p>
                ...
                @foreach($experience as $exp)
                    <div class="container">
                      <p class="col-sm-4" id="exp">
                          <p><h1>{{$exp->position}}</h1></p>
                        <p><h2>{{$exp->workplace}}</h2></p>
                        <p><h3>{{$exp->period}}</h3></p>
